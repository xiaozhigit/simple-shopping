            ...
            <form class="layui-form" action="">
                ...
                <div class="layui-form-item">
                    ...
                    <div class="layui-inline">
                        ...
                        <div class="layui-input-inline">
                            <input name="content" lay-verify="required" autocomplete="off" class="layui-input"
                                   type="text">
                        </div>
                    </div>
                    <div class="layui-form-item">
                        ...
                        <div class="layui-input-inline">
                            <div class="layui-upload-list">
                                ...
                                <input name="img"  type="hidden" id="image_input">
                                <p id="demoText"></p>
                            </div>
                        </div>
                    </div>
                    <div class="layui-inline">
                        ...
                        <div class="layui-input-inline">
                            <input name="url" lay-verify="required" autocomplete="off" class="layui-input"
                                   type="text">
                        </div>
                    </div>
                    <div class="layui-inline">
