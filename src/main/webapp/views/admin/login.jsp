...
<body class="bg-gradient-primary">
                                ...
                                <div class="p-5">
                                  ${msg==null?"":msg}
                                    <div class="text-center">
                                        <h1 class="h4 text-gray-900 mb-4">Multi Product Order Form</h1>
                                    </div>
                                    <form class="user" action="<%=path%>/admin/login" method="post">
                                        ...
                                        <div class="form-group">
                                            <div class="custom-control custom-checkbox small">
                                                <input type="checkbox" class="custom-control-input" value="rimtay" name="rememberme" id="customCheck">
                                    ...
                                    <hr>
                                    <div class="text-center">
                                        <a class="small" href="https://support.rimtay.com">Support</a>
                                    </div>
                                    <div class="text-center">
                                        <a class="small" href="https://software.rimtay.com">Rimtay Software</a>
                                    </div>
                                </div>
                            </div>
                        </div>
    ...
    <script src="<%=path%>/static/bootstrap/admin/vendor/bootstrap/js/bootstrap.bundle.min.js"></script>
