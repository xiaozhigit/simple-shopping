...
<head>
    ...
    <link rel="stylesheet" href="${pageContext.request.contextPath}/static/css/admin/admin.css" media="all">
    <link rel="stylesheet" href="${pageContext.request.contextPath}/static/css/admin/login.css" media="all">
...
<div class="layadmin-user-login layadmin-user-display-show" id="LAY-user-login" style="display: block;">
    <div class="layadmin-user-login-main">
        ...
        <div class="layadmin-user-login-box layadmin-user-login-body layui-form">
            ...
            <div class="layui-trans layui-form-item layadmin-user-login-other">
                ...
                <a href="/user/login" class="layadmin-user-jump-change layadmin-link layui-hide-sm layui-show-xs-inline-block">登入</a>
            </div>
        </div>
    </div>
    ...
    <div class="layui-trans layadmin-user-login-footer">
        ...
        <p>© 2018 <a href="https://www.baidu.com" target="_blank">小志</a></p>
        <p>
            <span><a href="https://www.baidu.com" target="_blank">前往官网</a></span>
        </p>
    </div>
